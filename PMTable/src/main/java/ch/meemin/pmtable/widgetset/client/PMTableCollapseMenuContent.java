 ...
 * 
 * @see com.vaadin.ui.Table#setCollapseMenuContent(PMTableCollapseMenuContent)
 * 
 * @since 7.6
 * @author Vaadin Ltd
 */
public enum PMTableCollapseMenuContent {
	/**
	 * All columns are shown in the collapse menu. Columns that are not collapsible are shown as disabled in the menu.
